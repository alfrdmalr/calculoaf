...
`;
  ...
  var NumberInput = (props) => {
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", { className: numberInput_module_css_default.container }, /* @__PURE__ */ import_react.default.createElement("label", { htmlFor: id }, label), /* @__PURE__ */ import_react.default.createElement(
      "input",
      __spreadProps(__spreadValues({}, rest), {
        required,
        type: "text",
        className: error ? numberInput_module_css_default.error : "",
        inputMode: "numeric",
...
`;
  ...
  var validateFormula = (f) => {
    return isValid(f.saltPercent) && isValid(f.levainPercent) && isValid(f.hydrationPercent);
  };

  // src/types/ingredients.tsx
  ...
  function applyFormula(formula, flourMass) {
    ...
    const waterMass = flourMass * hydrationDecimal;
    return {
      saltMass,
      levainMass,
      flourMass,
